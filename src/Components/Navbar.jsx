  ...
  return (
    <div className='flex justify-end items-center bg-black h-20 w-full px-4 fixed'>
        <ul className='hidden md:flex'>
            <li className=' text-gray-500 px-4 cursor-pointer capitalize font-medium hover:scale-100 duration-200'> home</li>
            <li className=' text-gray-500 px-4 cursor-pointer capitalize font-medium hover:scale-100 duration-200'> about me</li>
            <li className=' text-gray-500 px-4 cursor-pointer capitalize font-medium hover:scale-100 duration-200'> Portfolio</li>
            <li className=' text-gray-500 px-4 cursor-pointer capitalize font-medium hover:scale-100 duration-200'> contact us</li>
        </ul>
